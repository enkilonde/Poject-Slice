...
public class CreatePortal : MonoBehaviour {
	...
	private void GetPortalPos()
	{
		...
		RaycastHit _hit;
		LayerMask _layer = LayerMask.GetMask ("Ground", "Portal", "Ignored 1", "Ignored 2", "Ignored 3", "Ignored 4", "Ignored 5", "Ignored 6", "Ignored 7", "Ignored 8", "Ignored 9", "Ignored 11", "Ignored 12", "Ignored 13", "Ignored 14", "Ignored 15","Ignored 16");
